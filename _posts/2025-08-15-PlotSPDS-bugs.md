...
> <a href="https://forum.nanocad.ru/t/nanocad25-privyazat-format-promezhutki-mezhdu-formatami/989" target="_blank">подробнее тут</a>
>


1. ### Копирование выносок с зажатым CTRL
> При копировании нановыносок:
> 1. выделил выноску
> 1. взял за ручку
> 1. с зажатым CTRL потянул ручку (транзитная графика показывается)
> 1. клик
> 
> скопированная выноска не отображается сразу,\
> скопированное отобразится только после завершения команды 
> 
> при таком алгоритме:
> 1. выделил выноску
> 1. **пробел или Enter**
> 1. взял за ручку
> 1. с зажатым CTRL потянул ВСЮ выноску за ручку
> 1. клик
> 
> скопированные выноски отображаются сразу 
>
> _другие примитивы dwg и объекты мультикад при копировании показываются сразу, в процессе выполнения команды_

1. ### Редактирование на чертеже. Клавиатурные сочетания
> <i>касается редактирования мультикад объектов на чертеже: выноски, отметки уровня и т.п. (кроме нанотаблиц)</i> 
...
>> если перед неразрывным пробелом стоит символ кириллицы, то текст переноситься не будет.
