...
> <p>
> 
> Надо подключить сетевой ресурс виртуальным диском \
> из ком строки системы командой `SUBST` \
> например так, подключаем каталог как диск `Y`: 
> ```bat
> subst y: "\\C-SERVER\pko\Чертежи смежников"
> ```
> 
> и открывать файлы dwg с него
